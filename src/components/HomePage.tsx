  ...
  return (
    <HomeWrapper>
      <div
        ...
        <div className=" w-1/2">
          <div className="flex items-center pt-2 flex-col text-center h-3/4">
            ...
            <div className="text-xl pt-2 flex items-center justify-center flex-col">
              <p className=" w-1/2">
                I build scalable and reliable web applications from stable
                backend and frontend libraries and frameworks that work and
